 ...
 // }
  ...
  public static String  convert(BigDecimal myNumber){
       ...
       partie2Str =partie2Str.substring(2);
        ...
        Double par2 = new Double(partie2Str);
        ...
        if(par2==0){
            ...
            String par1 = partie1+"";
            return convert(new Double(par1))+" DHs";
        }
        ...
        if(partie2Str.startsWith("0")){
            System.out.println("taybeda b zeroooooooooooooo");
            return convert(new Double(partie1+""))+"  DHs ET "+convert(par2)+" CENTIMES";
        }
         if(par2<10){
            par2*=10;
        }
       return convert(new Double(partie1+""))+"  DHs ET "+convert(new Double(par2+""))+" CENTIMES";
